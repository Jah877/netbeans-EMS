...
public class RemoveEmployee extends javax.swing.JFrame {
    ...
    public void setMainHT(MyHashTable theRefVal){
        mainHT = theRefVal;
        System.out.println("REMOVE EMPLOYEE IS LIVE");
        
        model = new DefaultTableModel (new Object[]{"Emp Num", "Status", "First Name", "Last Name"},1);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Remove Employee Menu");

        jLabel2.setText("Remove an Employee by entering in their Employee Number:");
        ...
        removeButton.setText(" Remove Selected Employee");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(empNumField, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    try {
        ...
        if (foundEmployee != null) {
            // Employee found, display information
            ...
            if (foundEmployee instanceof FTE){
                ...
                model.setValueAt(foundEmployee.getEmpNum(), 0, 0);
                model.setValueAt("Full Time", 0, 1);
            ...
            if (foundEmployee instanceof PTE){
                ...
                model.setValueAt(foundEmployee.getEmpNum(), 0, 0);
                model.setValueAt("Part Time", 0, 1);
                model.setValueAt(foundEmployee.firstName, 0, 2);
                model.setValueAt(foundEmployee.lastName, 0, 3);
            }
...
try {
    if (flag){
        ...
        if (foundEmployee != null){
            ...
            JOptionPane.showMessageDialog(null, "Employee " + foundEmployee.firstName + " " + foundEmployee.lastName + " sucessfully removed.");
        ...
        throw new IllegalArgumentException("No employee is currently selected.");
    }
